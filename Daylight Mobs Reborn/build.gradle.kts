...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(475856, jar)
        file.displayName = "[${libs.versions.minecraft.get()}] Daylight Mobs Reborn"
...
modrinth {
    ...
    projectId = "daylight-mobs-reborn"
    uploadFile.set(tasks.jar)
    gameVersions.add(libs.versions.minecraft)
    versionName = libs.versions.minecraft.map { "[$it] Daylight Mobs Reborn" }
    dependencies {
